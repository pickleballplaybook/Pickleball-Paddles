...
import { buildReelDescription, buildHashtagLine } from "@/lib/reelDescription";
...
// now live in src/lib/reelDescription.ts so the /admin/publish auto-fill uses
// identical output. Imported at the top of this file.
// `buildHashtagLine` is unused locally now but kept in the import in case
// the UI starts surfacing it independently again.
void buildHashtagLine;
