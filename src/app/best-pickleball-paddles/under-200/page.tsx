...
export const metadata: Metadata = {
  title: `Best Pickleball Paddles Under $200 (${currentYear()}) — Tested & Ranked`,
  description:
    ...
    <>
      ...
      <div className="min-h-screen pt-[156px] pb-20" style={{ background: "var(--bg-page)" }}>
        <div className="container-xl py-16">
          ...
          <RelatedGuidesBlock
            slugs={["are-expensive-pickleball-paddles-worth-it", "how-to-choose-a-pickleball-paddle", "what-is-a-thermoformed-pickleball-paddle", "pickleball-paddle-thickness-explained"]}
            eyebrow="Go Deeper"
