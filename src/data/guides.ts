...
export const guides: Guide[] = [
  ...
  // ── Best pickleball shoes ──────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "verdict", text: "The Joola R4LLY is the most pickleball-specific shoe on the market right now and our top recommendation for most players. Tennis converts often prefer the ASICS Gel-Resolution 9 — same lateral support, more familiar feel. Whatever you pick, get a proper court shoe and replace it every 6–10 months." },
    ],
    faqs: [
  ...
  // ── Best outdoor pickleball balls ──────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { type: "verdict", text: "The Franklin X-40 is the safe default for outdoor play — it's the most common tournament ball and the most predictable flight you'll find. Dura Fast 40s are slightly more durable and cheaper, making them the rec-play default. For tournament prep, train with the ball the tournament uses." },
    ],
    faqs: [
      { q: "What is the best outdoor pickleball ball?", a: "The Franklin X-40 is the most-used outdoor tournament ball and the safe default for most outdoor players. Dura Fast 40 is a slightly cheaper, slightly more durable alternative common at rec centers and clubs. Both are USAPA-approved." },
