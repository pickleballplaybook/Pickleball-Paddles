  ...
  return (
    <section
      ...
      style={{
        ...
        paddingTop: "calc(env(safe-area-inset-top, 0px) + var(--topbar-h, 108px) + 64px)",
        minHeight: "100vh",
      }}
    >
      {/* Teal glow */}
      ...
      <div className="relative container-xl flex-1 flex items-start lg:items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-14 items-center w-full pb-6 lg:py-12">
          ...
          <div className="animate-flash-in flex items-center justify-center order-1 lg:order-2 mb-6 lg:mb-0">
